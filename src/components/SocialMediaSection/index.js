...
class SocialMediaSection extends Component {
  renderListItemsOfSocialMedia = () =>
    socialMediaAppsData.map(app => (
      <a href={app.siteUrl} key={app.id} className="social-size">
        <img src={app.imageUrl} alt={app.name} className="app-size" />
      </a>
    ))
  ...
  render() {
    return (
      <div className="socialMedia-container">
        {this.renderListItemsOfSocialMedia()}
      </div>
    )
  }
}
